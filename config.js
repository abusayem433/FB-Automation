...
const config = {
  ...
  // GROUP SETTINGS
  // ===========================================
  GROUP_URL: 'https://www.facebook.com/groups/ssc26prepartion/member-requests',
  
  // ===========================================
  // DECLINE MESSAGES (in Bangla)
  // ===========================================
  DECLINE_ALREADY_APPROVED: 'এই ট্রানজেকশন আইডি ব্যবহৃত হয়েছে',
  DECLINE_PHONE_MISMATCH: 'ফোন নম্বরটি এই ট্রানজেকশন আইডির জন্য সঠিক নয়, যে নম্বর দিয়ে আইডি খুলে কোর্স কিনেছেন সেই নম্বর দিন',
  ...
  DECLINE_DATABASE_ERROR: 'টেকনিক্যাল ত্রুটির কারণে আপনার অ্যাপ্রুভালটি ডিক্লাইন হয়েছে, যদি মনে হয় সব ঠিক আছে তাহলে পুনরায় রিকোয়েস্ট দিন',
